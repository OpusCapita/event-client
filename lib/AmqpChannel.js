...
class AmqpChannel
{
    ...
    async close()
    {
        ...
        if (this.channel) {
            ...
            try {
                await this.timeoutPromise(() => this.channel.close(), 2000);
            } catch (e) {
   ...
   */
    ...
    /**
     * Implements a Promise with timeout.
     *
     * TODO use bluebird-retry instead.
     *
     * @function timeoutPromise
     * @param {function} fn - Handler function to call with timeout
     * @param {timeout=1500} timeout to wait for handler execution.
     */
    timeoutPromise(fn, ms = 1500)
    {
        ...
        let cancelationPromise = new Promise(async () => {
            return fn();
        });
