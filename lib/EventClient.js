...
class EventClient
{
    ...
    init()
    {
        return Promise.resolve((async () =>
        {
            ...
            const channel = new AmqpChannel(this.connection, this.logger, this.connectionConfig, {useConfirmChannel: false});
            ...
            this.getChannel = new AmqpChannel(this.connection, this.logger, this.connectionConfig);
    ...
    /**
     * TODO this just sets the config on the connection not doing any reconnect ... ?
     *
     */
    async _doReconnect()
    {
