...
class EventClient
{
    ...
    getMessage(topic, autoAck = true)
    {
        return Promise.resolve((async () =>
        {
            ...
            try
            {
                message = await channel.getMessage(this.getQueueName(topic), autoAck);
            }
            finally
            {
                await channel.close();
    ...
    ackMessage(message)
    {
        return Promise.resolve(this.pubChannel.ackMessage({ fields : { deliveryTag : message.tag } }));
    }
    ...
    nackMessage(message)
    {
        return Promise.resolve(this.pubChannel.nackMessage({ fields : { deliveryTag : message.tag } }));
    }
    ...
    {
        return Promise.resolve(this.pubChannel.exchangeExists(exchangeName));
    }
    ...
    {
        return Promise.resolve(this.pubChannel.queueExists(queueName));
    }
    ...
    {
        return Promise.resolve(this.pubChannel.deleteQueue(queueName, opts));
    }
